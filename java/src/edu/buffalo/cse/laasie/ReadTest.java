...
public class ReadTest extends TestCase{
	...
	public void test1() {
		...
		while(iterator.hasNext()){
			...
			assertEquals("Dependencies:" + Actual.toString(),Expected,Actual.toString());
		}
	}
	...
	*/
	...
	public void test2() {
		...
		//String Actual = log.read(v2).toString();
	...
	*/
	...
	public void test3(){
		...
		String Expected = "[(A, []), (B, []), (C, [B]), (D, [A, B, C])]";
		String Actual;
		Iterator<Function> iterator = ((Iterator<Function>) log.iterRead(v1));
		while(iterator.hasNext()){
			Actual = iterator.next().toString();
	...
	*/
	...
	public void test5(){
		...
		log.write(df7);
		DummyFunction df8 = new DummyFunction(v1,readDeps1);
		log.write(df8);
		
		String Expected = "[(D, []), (C, []), (A, []), (A, [A]), (B, []), (B, [A, B]), (D, [D, C, A, B])]";
		String Actual;
		Iterator<Function> iterator = ((Iterator<Function>) log.iterRead(v1));
		while(iterator.hasNext()){
			Actual = iterator.next().toString();
	...
	*/
	...
	public void test5_2(){
		...
		String Expected = "[(D, []), (C, []), (A, []), (A, [A]), (B, []), (B, [A, B]), (D, [D, C, A, B]), (D, [D, C, A, B])]";
		String Actual;
		Iterator<Function> iterator = ((Iterator<Function>) log.iterRead(v1));
		while(iterator.hasNext()){
			Actual = iterator.next().toString();
	...
	*/
	...
	A:= 1
	B:= 1
	C:= 1 // Will not show up while reading
	A:= A+B
	B:= A
	C:= B
	*/
